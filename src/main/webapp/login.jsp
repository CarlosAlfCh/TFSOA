<%-- 
    Document   : login
    Created on : 7 oct. 2024, 10:32:27
    Author     : LENOVO
--%>
            ...
            <div class="form-structor">
                ...
                <form action="ServletValida" method="POST" class="signup"> 
                    <div class="form-group" >
                        ...
                        <a href="#" data-toggle="modal" data-target="#recuperar">Olvido su contraseña</a>
...
<!--                            <input type="date" class="input" name="txtfecha" placeholder="Fecha Nacimiento" required=""/>-->
            ...
            <div class="modal fade" id="recuperar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                 aria-hidden="true">
