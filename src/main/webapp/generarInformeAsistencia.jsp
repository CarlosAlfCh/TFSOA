...
<body>
    ...
    <section>
        <form action="GenerarInformeAsistenciaServlet" method="POST">
    ...
    <section>
        ...
        <script>
            ...
            const asistenciaChart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: ['Técnico 1', 'Técnico 2', 'Técnico 3', 'Técnico 4'], // Aquí van los técnicos
                    datasets: [{
                        label: 'Horas Trabajadas',
                        data: [10, 15, 20, 8], // Aquí van las horas trabajadas correspondientes
                        backgroundColor: [
                            'rgba(255, 99, 132, 0.2)',
                            'rgba(54, 162, 235, 0.2)',
                            'rgba(255, 206, 86, 0.2)',
